...
HD_PWD='C:/Users/Nader/Downloads/FINALICD/FINALICD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pnc_FSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pnc_FSM.tcl
