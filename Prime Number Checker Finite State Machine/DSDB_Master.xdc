...
## LEDs
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports {UserGuess}]; #IO_L12P_T1_MRCC_13 Sch=led[0]
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { PrimeLed }]; #IO_L12N_T1_MRCC_13 Sch=led[1]
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { GuessResult }]; #IO_L23P_T3_13 Sch=led[2]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { Led4[0] }]; #IO_L23N_T3_13 Sch=led[3]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { Led4[1] }]; #IO_L1P_T0_13 Sch=led[4]
set_property -dict { PACKAGE_PIN W12   IOSTANDARD LVCMOS33 } [get_ports { Led4[2] }]; #IO_L4N_T0_13 Sch=led[5]
set_property -dict { PACKAGE_PIN W11   IOSTANDARD LVCMOS33 } [get_ports { Led4[3] }]; #IO_L3P_T0_DQS_13 Sch=led[6]
...
## Elvis Port
set_property -dict { PACKAGE_PIN Y20   IOSTANDARD LVCMOS33 } [get_ports { Input[0]  }]; #IO_L9P_T1_DQS_33 Sch=pbc_dio[0]
set_property -dict { PACKAGE_PIN AA16  IOSTANDARD LVCMOS33 } [get_ports { Input[1]  }]; #IO_L18P_T2_33 Sch=pbc_dio[1]
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { Input[2]  }]; #IO_L11P_T1_SRCC_33 Sch=pbc_dio[2]
set_property -dict { PACKAGE_PIN AB16  IOSTANDARD LVCMOS33 } [get_ports { Input[3]  }]; #IO_L18N_T2_33 Sch=pbc_dio[3]
set_property -dict { PACKAGE_PIN AA18  IOSTANDARD LVCMOS33 } [get_ports { Input[4]  }]; #IO_L12N_T1_MRCC_33 Sch=pbc_dio[4]
set_property -dict { PACKAGE_PIN AB15  IOSTANDARD LVCMOS33 } [get_ports { Input[5]  }]; #IO_L24N_T3_33 Sch=pbc_dio[5]
set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { Input[6]  }]; #IO_L12P_T1_MRCC_33 Sch=pbc_dio[6]
set_property -dict { PACKAGE_PIN AA14  IOSTANDARD LVCMOS33 } [get_ports { Input[7]  }]; #IO_L22N_T3_33 Sch=pbc_dio[7]
